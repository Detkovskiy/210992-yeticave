<div class="container">
    ...
    <?php if ($page_count > 1) : ?>
        <ul class="pagination-list">
            <li class="pagination-item pagination-item-prev"><a href="all-lots.php?id=<?= $_GET['id']; ?>&page=<?= $current_page - 1; ?>">Назад</a></li>
            ...
            <li class="pagination-item pagination-item-next"><a href="all-lots.php?id=<?= $_GET['id']; ?>&page=<?= $current_page + 1; ?>">Вперед</a></li>
        </ul>
    <?php endif; ?>
</div>
